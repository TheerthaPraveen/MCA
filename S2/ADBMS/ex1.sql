...
create table jobs (job_id varchar(10) primary key,job_title varchar(20),min_salary decimal(10,2),max_salary decimal(10,2));

create table regions(region_id varchar(10) primary key,region_name varchar(50));

create table countries(country_id varchar(10) primary key,country_name varchar(30), region_id varchar(10),
foreign key(region_id) references regions(region_id));

create table locations(location_id varchar(10) primary key,street_address varchar(50), postal_code varchar(50),
city varchar(50),state_province varchar(50),country_id varchar(10),foreign key(country_id) references countries(country_id));

create table departments(department_id varchar(10) primary key,department_name varchar(50),location_id varchar(10),
...
relationship varchar(50),employee_id varchar(10),
foreign key(employee_id)references employees(employee_id));

-- rename departments to dept 
alter table departments rename dept;

-- modify column salary from varchar to int
alter table employees modify column salary int;

-- add column commision to employees table
alter table employees add commision varchar(50);

insert into regions (region_id,region_name) values ('1','Europe'),('2','Americas'),('3','Asia'),('4','Middle East And Africa');

insert into countries(country_id,country_name,region_id) values ('AR','Argentina',2),
 ('AU','Australia',3), ('BE','Belgium',1), ('BR','Brazil',2), ('CA','Canada',2), ('CH','Switzerland',1), ('CN','China',3), ('DE','Germany',1),
('DK','Denmark',1), ('EG','Egypt',4), ('FR','France',1), ('HK','HongKong',3),  ('IL','Israel',4),  ('IN','India',3),
 ('IT','Italy',1), ('JP','Japan',3), ('KW','Kuwait',4), ('MX','Mexico',2), ('NG','Nigeria',4), ('NL','Netherlands',1), ('SG','Singapore',3),
...
,(3,'Administration ',3000.00,6000.00),(4,'President',20000.00,40000.00),
(5,'Administration',15000.00,30000.00),(6,'Accountant',4200.00,9000.00),
(7,'Finance Manager',8200.00,16000.00),(8,'Human Resources',4000.00,9000.00),
(9,'Programmer',4000.00,10000.00),(10,'Marketing Manager',9000.00,15000.00),
(11,'Marketing Represente',4000.00,9000.00),(12,'Public Relations',4500.00,10500.00),
 (13,'Purchasing Clerk',2500.00,5500.00),(14,'Purchasing Manager',8000.00,15000.00),
(15,'Sales Manager',10000.00,20000.00),(16,'Sales Representa',6000.00,12000.00),
...
select country_name as Country_Name from countries;

-- write a query to display specific column like email and phone number of all employess
select email,phone_number from employees;

-- write a query to display the data of employee whose lastname is "Fay"
select * from employees where last_name="Fay";

-- to find the hire date for employees whose last name is Grant or Whalen
select hire_date,last_name from employees where last_name="Grant" or "Whalen";
select hire_date,last_name from employees where last_name in ("Grant","Whalen");

-- to display name of the employees who is shipping clerk
...
-- to get all the employees who work for the department 8
select * from employees where department_id=8;
select first_name,last_name from employees where department_id=8;
select first_name as FirstName ,last_name as LastName from employees where department_id=8;

-- to display the departments in desecending order
select department_name from dept
order by department_name desc;

-- display all the employees whose last name starts with "K"
select first_name,last_name from employees where last_name like "k%";

-- to get the last letter of the word
select substr(last_name,-1,1) from employees;

-- to get the first letter of the last_name
select substr(last_name,1,1) as First_Letter from employees;


-- just to now about the date format
select hire_date from employees limit 4;

-- display all the employees whose hire dates are between 1995 and 1997
...
--  display jobs where maximum salary is less than 9000
select job_title  from jobs where max_salary<=9000;

-- to display the employess emaill in upper case
select upper(email) as Email_Id from employees;

-- to display name of employees who were hired in 1995
select first_name,last_name,hire_date from employees where hire_date between "1995-01-01" and "1995-12-31";

-- query to insert an employee "Paul Newton" in department 11
...
(207,"Paul","Newton","paulneton7@gmail.com",'33332222','1998-08-23',2,12000.00,101,11);

--  to delete shipping department
delete from dept where department_name='Shipping';
select * from dept where department_name='Shipping';

-- to display the employees who were hired on Thursady
select first_name,last_name from employees where dayname(hire_date)='Thursday';
